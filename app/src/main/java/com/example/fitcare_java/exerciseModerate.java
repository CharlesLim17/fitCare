...
public class exerciseModerate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_moderate);
        ...
        //VIDEO URL
        videoPath = "android.resource://" + getPackageName() + "/" + R.raw.comp_workoutmoderate;
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                exerciseModerate.super.onBackPressed();
            }
        });

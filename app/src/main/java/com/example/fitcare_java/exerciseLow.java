...
public class exerciseLow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_low);
        ...
        //VIDEO URL
        videoPath = "android.resource://" + getPackageName() + "/" + R.raw.comp_workoutlow;
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                exerciseLow.super.onBackPressed();
            }
        });

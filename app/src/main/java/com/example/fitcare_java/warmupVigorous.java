...
public class warmupVigorous extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warmup_vigorous);
        ...
        //VIDEO URL
        videoPath = "android.resource://" + getPackageName() + "/" + R.raw.comp_warmupvigorous;
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                warmupVigorous.super.onBackPressed();
            }
        });

...
public class exerciseVigorous extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_exercise_vigorous);
        ...
        //VIDEO URL
        videoPath = "android.resource://" + getPackageName() + "/" + R.raw.comp_workoutvigorous;
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                exerciseVigorous.super.onBackPressed();
            }
        });
